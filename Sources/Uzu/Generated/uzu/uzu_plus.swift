...
public protocol EngineProtocol: AnyObject, Sendable {
    ...
    func benchmark(task: BenchmarksTask, prefillStepSize: Int64?) async throws  -> [BenchmarksResult]
...
open func benchmark(task: BenchmarksTask, prefillStepSize: Int64?)async throws  -> [BenchmarksResult]  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_uzu_plus_fn_method_engine_benchmark(
                    self.uniffiCloneHandle(),
                    FfiConverterTypeBenchmarksTask_lower(task),FfiConverterOptionInt64.lower(prefillStepSize)
                )
            },
            pollFunc: ffi_uzu_plus_rust_future_poll_rust_buffer,
            completeFunc: ffi_uzu_plus_rust_future_complete_rust_buffer,
...
public struct BenchmarksDevice: Equatable, Hashable, Codable {
...
public struct BenchmarksResult: Equatable, Hashable, Codable {
...
public struct BenchmarksTask: Equatable, Hashable, Codable {
...
public struct ChatModel: Equatable, Hashable, Codable {
    public var repoId: String
...
public struct ClassificationFeature: Equatable, Hashable, Codable {
    public var name: String
...
public struct Config: Equatable, Hashable, Codable {
...
public struct Message: Equatable, Hashable, Codable {
...
public struct ModelDownloadState: Equatable, Hashable, Codable {
    /**
...
public struct Output: Equatable, Hashable, Codable {
...
public struct ParsedText: Equatable, Hashable, Codable {
...
public struct ProgressUpdate: Equatable, Hashable, Codable {
    /**
...
public struct RunConfig: Equatable, Hashable, Codable {
    public var tokensLimit: Int64
    public var enableThinking: Bool
    public var samplingPolicy: SamplingPolicy
    public var grammarConfig: GrammarConfig?

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(tokensLimit: Int64, enableThinking: Bool, samplingPolicy: SamplingPolicy, grammarConfig: GrammarConfig?) {
        self.tokensLimit = tokensLimit
...
public struct FfiConverterTypeRunConfig: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RunConfig {
        return
            try RunConfig(
                ...
                grammarConfig: FfiConverterOptionTypeGrammarConfig.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: RunConfig, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionTypeGrammarConfig.write(value.grammarConfig, into: &buf)
    }
}
...
public struct RunStats: Equatable, Hashable, Codable {
...
public struct Stats: Equatable, Hashable, Codable {
...
public struct StepStats: Equatable, Hashable, Codable {
...
public struct TotalStats: Equatable, Hashable, Codable {
    public var duration: Double
...
public enum AsyncBatchSize: Equatable, Hashable, Codable {
...
public enum ContextMode: Equatable, Hashable, Codable {
...
public enum DataType: Equatable, Hashable, Codable {
...
public enum EngineError: Swift.Error, Equatable, Hashable, Codable {
...
public enum Error: Swift.Error, Equatable, Hashable, Codable {
    ...
    case LanguageModelGeneratorNotLoaded
    ...
    case GrammarReject
    case TokenOutOfGrammarRange(UInt64,UInt64
    )
    case ClassifierError(String
    )
...
public struct FfiConverterTypeError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Error {
        ...
        case 10: return .LanguageModelGeneratorNotLoaded
        ...
        case 21: return .GrammarError(
            try FfiConverterString.read(from: &buf)
            )
        case 22: return .GrammarReject
        case 23: return .TokenOutOfGrammarRange(
            try FfiConverterUInt64.read(from: &buf), 
            try FfiConverterUInt64.read(from: &buf)
            )
        case 24: return .ClassifierError(
            try FfiConverterString.read(from: &buf)
            )
        case 25: return .UnexpectedCallSequence
        case 26: return .UnsupportedPreset
        case 27: return .UnsupportedContextMode
        case 28: return .ResponseParseError
        case 29: return .NetworkError(
            message: try FfiConverterString.read(from: &buf)
            )
        case 30: return .HttpError(
...
public enum FinishReason: Equatable, Hashable, Codable {
...
public enum GrammarConfig: Equatable, Hashable, Codable {
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeGrammarConfig: FfiConverterRustBuffer {
    typealias SwiftType = GrammarConfig

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> GrammarConfig {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        
        case 1: return .jsonSchema(schema: try FfiConverterString.read(from: &buf)
        )
        
        case 2: return .regex(pattern: try FfiConverterString.read(from: &buf)
        )
        
        case 3: return .builtinJson
        
        default: throw UniffiInternalError.unexpectedEnumCase
        }
    }

    public static func write(_ value: GrammarConfig, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeGrammarConfig_lift(_ buf: RustBuffer) throws -> GrammarConfig {
    return try FfiConverterTypeGrammarConfig.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeGrammarConfig_lower(_ value: GrammarConfig) -> RustBuffer {
    return FfiConverterTypeGrammarConfig.lower(value)
}
...
public enum Input: Equatable, Hashable, Codable {
...
public enum LicenseStatus: Equatable, Hashable, Codable {
...
public enum ModelDownloadPhase: Equatable, Hashable, Codable {
...
public enum ModelStorageError: Swift.Error, Equatable, Hashable, Codable {
...
public enum ModelType: Equatable, Hashable, Codable {
...
public enum NetworkError: Swift.Error, Equatable, Hashable, Codable {
...
public enum PrefillStepSize: Equatable, Hashable, Codable {
...
public enum Preset: Equatable, Hashable, Codable {
...
public enum StorageError: Swift.Error, Equatable, Hashable, Codable {
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeGrammarConfig: FfiConverterRustBuffer {
    typealias SwiftType = GrammarConfig?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeGrammarConfig.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeGrammarConfig.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_uzu_plus_checksum_method_engine_benchmark() != 4535) {
        return InitializationResult.apiChecksumMismatch
    }
