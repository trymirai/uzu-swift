...
struct SummarizationView: View {
    ...
    @State private var inputText: String = SummarizationView.textsToSummarize
    ...
    private var input: some View {
        ZStack(alignment: .topLeading) {
            TextField("Enter text to summarise...", text: $inputText, axis: .vertical)
    ...
    private func runSummarisation() {
        ...
        let textToSummarise = inputText.trimmingCharacters(in: .whitespacesAndNewlines)
